...
- Choose Project Folder that existed [Prospace]
...
- Double click Test Suite Collection [Prospace_Factorial_Calculator_TSC]
- Under the Execution Information, click on Excecute button
- The script will be executed and the report will generated at the end of the execution

Step to investigate the report:
- Go to File Explorer
- Navigate to Project Folder [Prospace] > Reports > find the latest folder
- Choose the Test Suite folder [Prospace_Factorial_Calculator_TS]
